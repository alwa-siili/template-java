...
public class StructArray2InterfaceClient extends AbstractStructArray2Interface implements ServiceConnection
{
    ...
    class ClientHandler extends Handler {
	    ...
	    {
		    Log.i(TAG, "Handle msg " + msg + " " + StructArray2InterfaceMessageType.fromInteger(msg.what));
    ...
    // therefore, any class loader provide access to the same PathClassLoader.
        ...
        data.setClassLoader(StructStringWithArrayParcelable.class.getClassLoader());
			    ...
			    case RPC_FuncBoolResp: {
                    ...
                    {
                        Log.i(TAG, "received StructArray2InterfaceMessageType.RPC_FuncBoolResp , could not find pending call for " + msg.obj);
                    }
				    break;
			    ...
			    case RPC_FuncIntResp: {
                    ...
                    {
                        Log.i(TAG, "received StructArray2InterfaceMessageType.RPC_FuncIntResp , could not find pending call for " + msg.obj);
                    }
				    break;
			    ...
			    case RPC_FuncFloatResp: {
                    ...
                    {
                        Log.i(TAG, "received StructArray2InterfaceMessageType.RPC_FuncFloatResp , could not find pending call for " + msg.obj);
                    }
				    break;
			    ...
			    case RPC_FuncStringResp: {
                    ...
                    {
                        Log.i(TAG, "received StructArray2InterfaceMessageType.RPC_FuncStringResp , could not find pending call for " + msg.obj);
                    }
				    break;
			    ...
			    case RPC_FuncEnumResp: {
                    ...
                    {
                        Log.i(TAG, "received StructArray2InterfaceMessageType.RPC_FuncEnumResp , could not find pending call for " + msg.obj);
                    }
				    break;
